									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													TV<br> <span class="myPointListTitle_Title">결제 확인</span>
											</h2>
										</div>
									</div>
								</div>
								<div class="UserPageGrid">
										<div class="UserPageRow">
											<div class="container" align="center">
												<form action="tvPay.do?tvNum='${tv.tvNum}'">
													<input type="hidden" name="tvNum" value="${tv.tvNum }">
													<input type="hidden" name="tvEpNum"
														value="${tvEp.tvEpNum }"> <input type="hidden"
													...
													<table class="table">
														...
														<tr>
															<th>회차</th>
															<td>${tvEp.tvEpNum}화</td>
														</tr>
														<tr>
															<th>TV 프로그램 가격</th>
															<td>${tvEp.tvEpPrice}원</td>
														</tr>
														<tr>
															<th>나의 현재 포인트</th>
																...
																<td colspan="2">
																	<h3 class="ment_hello">
																		포인트 잔액이 부족하여 충전이 필요해요<br> 충전은 <a
																			href="pChargeForm.do?tvNum=${t.tvNum}&movNum=0"><span
														...
														<c:if test="${balance >= 0 }">
															<tr>
																<td colspan="2" class="textAlign"><input type="submit" value="결제하기"
