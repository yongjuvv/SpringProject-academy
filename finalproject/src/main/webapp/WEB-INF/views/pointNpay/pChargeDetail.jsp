							...
							<section class="UserPage_MyPage">
									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													포인트<br> <span class="myPointListTitle_Title">충전 확인</span>
											</h2>
										</div>
									</div>
								</div>
								<div class="UserPageGrid">
										<div class="UserPageRow">
											...
											<div class="container">
												<form method="post"
													action="pointPayChk.do?movNum=${movNum }&tvNum=${tvNum}"
													name="buyinput">
													<input type="hidden" name="pProductNum"
														value="${pproduct.pProductNum}"> <input
														type="hidden" name="movNum" value="${movNum }"> <input
														type="hidden" name="tvNum" value="${tvNum }">
													<table class="table">
														<tr>
															<th>이메일</th>
															<td>${pmember.email }</td>
														...
														<tr>
															<td colspan="2" style="text-align: center;"><input
																...
																value="충전하기" class="NextButtonCss"></td>
														</tr>
													</table>
												</form>
											</div>
