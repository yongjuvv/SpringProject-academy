									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													포인트<br> <span class="myPointListTitle_Title">충전 하기</span>
											</h2>
										</div>
									</div>
								</div>
										...
										<div class="UserPageRow">
											<div class="container" align="center">
												...
												<form action="pChargeDetail.do">
													...
													<table class="table">
														<tr>
															<td style="border-top: none;"><label> <input
																	type="radio" name="pProductNum" value="1"
																	required="required" /> 1,000p | 1,000원
															</label></td>
														</tr>
														<tr>
															<td style="border-top: none;"><label> <input
																	type="radio" name="pProductNum" value="2" /> 5,500p
																	(5,000p + 충전 보너스 10% up! 500p) | 5,000원
															</label></td>
														</tr>
														<tr>
															<td style="border-top: none;"><label> <input
																	type="radio" name="pProductNum" value="3" /> 12,000p
																	(10,000p + 충전 보너스 20% up! 2,000p) | 10,000원
															</label></td>
														</tr>
														<tr>
															<td style="border-top: none;"><label> <input
																	type="radio" name="pProductNum" value="4" /> 26,000p
																	(20,000p + 충전 보너스 30% up! 6,000p) | 20,000원
															</label></td>
														</tr>
														<tr>
															<td class="NextButton"><input type="submit" value="다음"
																class="NextButtonCss" /></td>
														</tr>
													</table>
												</form>
											</div>
