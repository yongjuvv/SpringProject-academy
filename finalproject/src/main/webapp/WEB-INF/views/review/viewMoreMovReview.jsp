...
<style>
@import url("${path}/css/viewMoreMovReview.css");
</style>
<body>
	<div class="root">
											...
											<div class="BasicCommentItem_Comment">
												<div class="BasicCommentItem_TitleContainer">
													<div class="BasicCommentItem_ProfileBlock">
														<a class="ProfileBlockA"
															href="otherReviewList.do?email=${review.email}">
													...
													<button class="likebtn" onclick="like(${review.reviewNum})">
														<c:choose>
															...
															<c:when test="${review.likeChk == 1}">
																<span id="like_${review.reviewNum}"
																	class="clickLike like">좋아요</span>
															</c:when>
														</c:choose>
													</button>
												</div>
