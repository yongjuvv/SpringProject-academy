									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													탈퇴<br> <span class="myPointListTitle_Title">비밀번호 확인</span>
											</h2>
										</div>
									</div>
								</div>
								<div class="UserPageGrid">
										<div class="UserPageRow">
											<div class="container" align="center">
												<form action="memDelForm2.do" name="frm" method="post"
													onsubmit="return passChk()">
													<table class="table">
														<tr>
															<td><input type="password" name="pass"
																required="required" id="pass" class="form-control"
																maxlength="15" placeholder="지금 사용하고 있는 비밀번호를 입력하세요">
																<div class="err" id="passCk"></div></td>
														</tr>
														<tr>
															<td align="center"><input type="submit"
																value="다음 단계로" class="NextButtonCss"></td>
														</tr>
													</table>
												</form>
											</div>
