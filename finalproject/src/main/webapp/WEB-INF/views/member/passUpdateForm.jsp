...
function chk() {
	if (frm.pass2.value != frm.password2.value) {
		$("#pck").text("비밀번호가 달라요").css("color","red");
		frm.password2.focus();
		return false;
	}
}
									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													새로운<br> <span class="myPointListTitle_Title">비밀번호</span>
											</h2>
										</div>
									</div>
								</div>
								<div class="UserPageGrid">
										<div class="UserPageRow">
											<div class="container" align="center">
												<form action="passUpdate.do" method="post" name="frm"
													onsubmit="return chk()">
													<input type="hidden" name="email" value="${member.email}">
													<table class="table">
														<tr>
															<th width="">새로운 비밀번호</th>
															<td><input type="password" name="pass2"
																required="required" placeholder="바꾸고 싶은 비밀번호를 입력하세요"
																class="form-control"></td>
														</tr>
														<tr>
															<th width="40%">비밀번호 확인</th>
															<td><input type="password" name="password2"
																required="required" placeholder="한번 더 입력하세요"
																class="form-control">
																<div id="pck"></div></td>
														</tr>
														<tr>
															<td colspan="2" style="text-align: center;"><input
																type="submit" value="비밀번호 바꾸기" class="NextButtonCss"><br></td>
														</tr>
													</table>
												</form>
											</div>
