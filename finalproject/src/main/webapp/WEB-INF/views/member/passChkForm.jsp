...
/*  		alert("비밀번호가 다릅니다");
 */		$("#pck").text("맞는 비밀번호를 입력해주세요").css("color","red");
		frm.pass2.focus();
		return false;
	}
}
									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													현재<br> <span class="myPointListTitle_Title">비밀번호 확인</span>
											</h2>
										</div>
									</div>
								</div>
								<div class="UserPageGrid">
										<div class="UserPageRow">
											<div class="container" align="center">
												<form action="passUpdateForm.do" method="post" name="frm"
													onsubmit="return chk()">
													<input type="hidden" name="pass" value="${pass}">
													<table class="table">
														<tr>
															<th width="40%">현재 비밀번호 확인</th>
															<td><input type="password" name="pass2"
																required="required" placeholder="지금 사용하고 있는 비밀번호를 입력하세요"
																class="form-control">
																<div id="pck"></div></td>
														</tr>
														<tr>
															<td colspan="2" style="text-align: center;"><input
																type="submit" value="다음 단계로" class="NextButtonCss">
															</td>
														</tr>
													</table>
												</form>
