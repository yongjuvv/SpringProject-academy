									...
									<div class="UserPage_WallPaperRow">
										<div class="UserPage_WallPaperTitle">
											<h2 class="myPointListTitle">
													내가 만든<br> <span class="myPointListTitle_Title">콜렉션</span>
											</h2>
										</div>
									</div>
									<div>
										<button class="newCollectionButton searchButtonCss" onclick="location.href='newCollection.do'">새 컬렉션</button>
									</div>
								</div>
										...
										<div class="UserPageRow">
											<div class="container" align="center">
												<table class="table" style="font-size: 14px;">
													...
													<c:forEach var="collect" items="${collectList}">
														<tr>
															<td><fmt:formatDate value="${collect.collDate}"
																	pattern="M/d HH:mm" /></td>
															
															<td><a href="myCollectListDetail.do?collNum=${collect.collNum}">${collect.collName}</a></td>
											...
											<div class="container pageList" align="center">
												<c:if test="${startPage > pagePerBlock }">
													<a href="myCollectionList.do?pageNum=${startPage-1}">이전</a>
												</c:if>
												<c:forEach var="i" begin="${startPage}" end="${endPage }">
													<a href="myCollectionList.do?pageNum=${i}">${i}</a>
												</c:forEach>
												<c:if test="${endPage < totPage }">
													<a href="myCollectionList.do?pageNum=${endPage+1}">다음</a>
												</c:if>
											</div>
