	...
	<section class="bi">
		<div class="form-row float-center">
			<div class="col-12 col-md-8 col-lg-6" id="pad1">
				<h1 id="font2" style="color: white;" align="left">언제 어디서든 당신의 반려동물의 위치를
					확인하세요.</h1>
				<br>
				<h2 id="font2" style="color: white;" align="left">반려동물의 건강상태를 체크해주세요!</h2>
			</div>
		</div>
		<div class="form-row float-center" id="pad2" style="margin:auto;">
			<div class="col-12 col-xl-3 button-div" id="pad3">
				<c:choose>
					<c:when test="${not empty cId }">
						<a href="gonow.do">
							<button type="button" id="but1" style="font-size:150%">Check Location</button>
						</a>
					</c:when>
			...
			<div class="col-12 col-xl-3 button-div" id="pad3">
				<c:choose>
					<c:when test="${not empty cId }">
						<a href="gonow.do" >
							<button type="button" id="but" style="font-size:150%">Check Health</button>
						</a>
					</c:when>
					<c:when test="${empty cId }">
						<a href="loginForm.do" >
